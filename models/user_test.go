...
func TestCreateUser_Issue5882(t *testing.T) {
	...
	tt := []struct {
		...
		{&User{Name: "NxgitBot", Email: "NxgitBot@nxgit.io", Passwd: passwd, MustChangePassword: false}, false},
		{&User{Name: "NxgitBot2", Email: "NxgitBot2@nxgit.io", Passwd: passwd, MustChangePassword: false}, true},
	}
