...
const (
	tplCommentPrefix = `# nxgit public key`
...
func writeTmpKeyFile(content string) (string, error) {
	tmpFile, err := ioutil.TempFile(setting.SSH.KeyTestPath, "nxgit_keytest")
	if err != nil {
...
func rewriteAllPublicKeys(e Engine) error {
	...
	if setting.SSH.AuthorizedKeysBackup && com.IsExist(fPath) {
		bakPath := fmt.Sprintf("%s_%d.nxgit_bak", fPath, time.Now().Unix())
