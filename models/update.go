...
const (
	EnvRepoName     = "NXGIT_REPO_NAME"
	EnvRepoUsername = "NXGIT_REPO_USER_NAME"
	EnvRepoIsWiki   = "NXGIT_REPO_IS_WIKI"
	EnvPusherName   = "NXGIT_PUSHER_NAME"
	EnvPusherEmail  = "NXGIT_PUSHER_EMAIL"
	EnvPusherID     = "NXGIT_PUSHER_ID"
)
