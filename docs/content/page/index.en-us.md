...
Nxgit is a painless self-hosted Git service. It is similar to GitHub, Bitbucket, and GitLab.
Nxgit is a fork of [Gogs](http://gogs.io). See the [Nxgit Announcement](https://blog.nxgit.io/2016/12/welcome-to-nxgit/)
...
- Multi-language support ([21 languages](https://github.com/khulnasoft/nxgit/tree/master/options/locale))
- Mail service
    - Notifications
...
- A Raspberry Pi 3 is powerful enough to run Nxgit for small workloads.
- 2 CPU cores and 1GB RAM is typically sufficient for small teams/projects.
- Nxgit should be run with a dedicated non-root system account on UNIX-type systems.
   - Note: Nxgit manages the `~/.ssh/authorized_keys` file. Running Nxgit as a regular user could break that user's ability to log in.
