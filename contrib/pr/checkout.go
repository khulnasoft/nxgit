...
import (
	...
	"go.khulnasoft.com/nxgit/modules/markup/external"
...
func runPR() {
	...
	*/
	...
	com.CopyDir(path.Join(curDir, "integrations/nxgit-repositories-meta"), setting.RepoRootPath)
...
func main() {
	...
	for _, r := range remotes {
		if r.Config().URLs[0] == "https://github.com/khulnasoft/nxgit" || r.Config().URLs[0] == "git@github.com:khulnasoft/nxgit.git" { //fetch at index 0
