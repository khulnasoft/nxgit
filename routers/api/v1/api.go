...
// Package v1 Nxgit API.
//
// This documentation describes the Nxgit API.
//
//	Schemes: http, https
//	BasePath: /api/v1
//	Version: 1.1.1
...
import (
	...
	"go.khulnasoft.com/nxgit/routers/api/v1/admin"
	"go.khulnasoft.com/nxgit/routers/api/v1/misc"
	"go.khulnasoft.com/nxgit/routers/api/v1/org"
	"go.khulnasoft.com/nxgit/routers/api/v1/repo"
	_ "go.khulnasoft.com/nxgit/routers/api/v1/swagger" // for swagger generation
	"go.khulnasoft.com/nxgit/routers/api/v1/user"
