...
import (
	...
	"go.khulnasoft.com/nxgit/modules/gzip"
	"go.khulnasoft.com/nxgit/modules/lfs"
	"go.khulnasoft.com/nxgit/modules/log"
	"go.khulnasoft.com/nxgit/modules/metrics"
	"go.khulnasoft.com/nxgit/modules/options"
	"go.khulnasoft.com/nxgit/modules/public"
	"go.khulnasoft.com/nxgit/modules/setting"
	"go.khulnasoft.com/nxgit/modules/templates"
	"go.khulnasoft.com/nxgit/modules/validation"
	"go.khulnasoft.com/nxgit/routers"
	"go.khulnasoft.com/nxgit/routers/admin"
	apiv1 "go.khulnasoft.com/nxgit/routers/api/v1"
	"go.khulnasoft.com/nxgit/routers/dev"
	"go.khulnasoft.com/nxgit/routers/org"
	"go.khulnasoft.com/nxgit/routers/private"
	"go.khulnasoft.com/nxgit/routers/repo"
	"go.khulnasoft.com/nxgit/routers/user"
	userSetting "go.khulnasoft.com/nxgit/routers/user/setting"
...
func nxgitLogger(l *log.LoggerAsWriter) macaron.Handler {
...
func NewMacaron() *macaron.Macaron {
	...
	if setting.RedirectMacaronLog {
		...
		if !setting.DisableRouterLog {
			m.Use(nxgitLogger(loggerAsWriter))
		}
	} else {
		m = macaron.New()
		if !setting.DisableRouterLog {
		...
		m.Group("/:org", func() {
			...
			m.Group("/settings", func() {
				...
				m.Group("/hooks", func() {
					...
					m.Post("/nxgit/new", bindIgnErr(auth.NewWebhookForm{}), repo.WebHooksNewPost)
					m.Post("/gogs/new", bindIgnErr(auth.NewGogshookForm{}), repo.GogsHooksNewPost)
					m.Post("/slack/new", bindIgnErr(auth.NewSlackHookForm{}), repo.SlackHooksNewPost)
					m.Post("/discord/new", bindIgnErr(auth.NewDiscordHookForm{}), repo.DiscordHooksNewPost)
					m.Post("/dingtalk/new", bindIgnErr(auth.NewDingtalkHookForm{}), repo.DingtalkHooksNewPost)
					m.Get("/:id", repo.WebHooksEdit)
					m.Post("/nxgit/:id", bindIgnErr(auth.NewWebhookForm{}), repo.WebHooksEditPost)
