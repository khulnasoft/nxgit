...
func TestSizedAvatarLink(t *testing.T) {
	...
	assert.Equal(t, "/img/avatar_default.png",
		SizedAvatarLink("nxgit@example.com", 100))
...
func TestAvatarLink(t *testing.T) {
	disableGravatar()
	assert.Equal(t, "/img/avatar_default.png", AvatarLink("nxgit@example.com"))

	enableGravatar(t)
	assert.Equal(t,
		"https://secure.gravatar.com/avatar/353cbad9b58e69c96154ad99f92bedc7?d=identicon",
		AvatarLink("nxgit@example.com"),
	)
}
