...
func TestRender_CrossReferences(t *testing.T) {
	...
	test(
		"khulnasoft/nxgit#12345",
		`<p><a href="`+util.URLJoin(AppURL, "khulnasoft", "nxgit", "issues", "12345")+`" rel="nofollow">khulnasoft/nxgit#12345</a></p>`)
}
...
func TestRender_links(t *testing.T) {
	...
	test(
		"https://github.com/khulnasoft/nxgit/?p=aaa/bbb.html#ccc-ddd",
		`<p><a href="https://github.com/khulnasoft/nxgit/?p=aaa/bbb.html#ccc-ddd" rel="nofollow">https://github.com/khulnasoft/nxgit/?p=aaa/bbb.html#ccc-ddd</a></p>`)
	test(
