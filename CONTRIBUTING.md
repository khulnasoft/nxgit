...
- [Contribution Guidelines](#contribution-guidelines)
  ...
  - [Owners](#owners)
  - [Versions](#versions)
  - [Releasing Nxgit](#releasing-nxgit)
  - [Copyright](#copyright)

## Introduction

This document explains how to contribute changes to the Nxgit project.
It assumes you have followed the
[installation instructions](https://docs.nxgit.io/en-us/).
Sensitive security-related issues should be reported to
[security@nxgit.io](mailto:security@nxgit.io).

For configuring IDE or code editor to develop Nxgit see [IDE and code editor configuration](contrib/ide/)
...
If unique, [open an issue](https://github.com/khulnasoft/nxgit/issues/new)
and answer the questions so we can understand and reproduce the
problematic behavior.

To show us that the issue you are having is in Nxgit itself, please
write clear, concise instructions so we can reproduce the behavior—
even if it seems obvious. The more detailed and specific you are,
the faster we can fix the issue. Check out [How to Report Bugs
Effectively](http://www.chiark.greenend.org.uk/~sgtatham/bugs.html).

Please be kind, remember that Nxgit comes at no cost to you, and you're
getting free help.

## Discuss your design

The project welcomes submissions. If you want to change or add something,
please let everyone know what you're working on—[file an issue](https://github.com/khulnasoft/nxgit/issues/new)!
...
- Ensure you have enough free disk space.  You will need at least
  ...
  [#6243](https://github.com/khulnasoft/nxgit/issues/6243)).  
- Change into the base directory of your copy of the nxgit repository,
  and run `drone exec --local --build-event pull_request`.

The drone version, command line, and disk requirements do change over
time (see [#4053](https://github.com/khulnasoft/nxgit/issues/4053) and
[#6243](https://github.com/khulnasoft/nxgit/issues/6243)); if you
...
We do all translation work inside [Crowdin](https://crowdin.com/project/nxgit).
The only translation that is maintained in this git repository is
[`en_US.ini`](https://github.com/khulnasoft/nxgit/blob/master/options/locale/locale_en-US.ini)
...
Changes to Nxgit must be reviewed before they are accepted—no matter who
...
should be a contributor of Nxgit (or Gogs) and contributed at least
...
team](https://github.com/orgs/khulnasoft/teams/advisors). Of course, if
...
Since Nxgit is a pure community organization without any company support,
...
```
I'm honored to having been elected an owner of Nxgit, I agree with
[CONTRIBUTING](CONTRIBUTING.md). I will spend part of my time on Nxgit
and lead the development of Nxgit.
```
...
Nxgit has the `master` branch as a tip branch and has version branches
such as `release/v0.9`. `release/v0.9` is a release branch and we will
tag `v0.9.0` for binary download. If `v0.9.0` has bugs, we will accept
pull requests on the `release/v0.9` branch and publish a `v0.9.1` tag,
after bringing the bug fix also to the master branch.

Since the `master` branch is a tip version, if you wish to use Nxgit
...
* Let $vmaj, $vmin and $vpat be Major, Minor and Patch version numbers, $vpat should be rc1, rc2, 0, 1, ...... $vmaj.$vmin will be kept the same as milestones on github or nxgit in future.
...
* Send PR to [blog repository](https://github.com/khulnasoft/blog) announcing the release.
